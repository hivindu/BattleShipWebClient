        ...
        <div class="container">
                ...
                <div class="col-md-5 pull-left" style="background-image:url('Images/divback.jpg');background-size:cover;">
                    <table>
                        ...
                        <tr>
                            <td>1</td>
                            <td>
                                <asp:Button ID="A1" runat="server" Text="A1" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="B1" runat="server" Text="B1" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="C1" runat="server" Text="C1" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="D1" runat="server" Text="D1" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="E1" runat="server" Text="E1" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="F1" runat="server" Text="F1" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="G1" runat="server" Text="G1" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="H1" runat="server" Text="H1" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="I1" runat="server" Text="I1" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="J1" runat="server" Text="J1" class ="btn btn-block"/>
                            </td>
                        </tr>
                        <tr>
                            <td>2</td>
                            <td>
                                <asp:Button ID="A2" runat="server" Text="A2" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="B2" runat="server" Text="B2" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="C2" runat="server" Text="C2" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="D2" runat="server" Text="D2" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="E2" runat="server" Text="E2" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="F2" runat="server" Text="F2" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="G2" runat="server" Text="G2" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="H2" runat="server" Text="H2" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="I2" runat="server" Text="I2" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="J2" runat="server" Text="J2" class ="btn btn-block"/>
                            </td>
                        </tr>
                        <tr>
                            <td>3</td>
                            <td>
                                <asp:Button ID="A3" runat="server" Text="A3" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="B3" runat="server" Text="B3" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="C3" runat="server" Text="C3" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="D3" runat="server" Text="D3" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="E3" runat="server" Text="E3" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="F3" runat="server" Text="F3" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="G3" runat="server" Text="G3" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="H3" runat="server" Text="H3" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="I3" runat="server" Text="I3" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="J3" runat="server" Text="J3" class ="btn btn-block"/>
                            </td>
                        </tr>
                        <tr>
                            <td>4</td>
                            <td>
                                <asp:Button ID="A4" runat="server" Text="A4" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="B4" runat="server" Text="B4" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="C4" runat="server" Text="C4" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="D4" runat="server" Text="D4" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="E4" runat="server" Text="E4" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="F4" runat="server" Text="F4" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="G4" runat="server" Text="G4" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="H4" runat="server" Text="H4" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="I4" runat="server" Text="I4" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="J4" runat="server" Text="J4" class ="btn btn-block"/>
                            </td>
                        </tr>
                        <tr>
                            <td>5</td>
                            <td>
                                <asp:Button ID="A5" runat="server" Text="A5" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="B5" runat="server" Text="B5" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="C5" runat="server" Text="C5" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="D5" runat="server" Text="D5" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="E5" runat="server" Text="E5" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="F5" runat="server" Text="F5" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="G5" runat="server" Text="G5" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="H5" runat="server" Text="H5" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="I5" runat="server" Text="I5" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="J5" runat="server" Text="J5" class ="btn btn-block"/>
                            </td>
                        </tr>
                        <tr>
                            <td>6</td>
                            <td>
                                <asp:Button ID="A6" runat="server" Text="A6" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="B6" runat="server" Text="B6" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="C6" runat="server" Text="C6" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="D6" runat="server" Text="D6" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="E6" runat="server" Text="E6" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="F6" runat="server" Text="F6" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="G6" runat="server" Text="G6" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="H6" runat="server" Text="H6" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="I6" runat="server" Text="I6" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="J6" runat="server" Text="J6" class ="btn btn-block"/>
                            </td>
                        </tr>
                        <tr>
                            <td>7</td>
                            <td>
                                <asp:Button ID="A7" runat="server" Text="A7" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="B7" runat="server" Text="B7" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="C7" runat="server" Text="C7" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="D7" runat="server" Text="D7" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="E7" runat="server" Text="E7" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="F7" runat="server" Text="F7" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="G7" runat="server" Text="G7" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="H7" runat="server" Text="H7" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="I7" runat="server" Text="I7" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="J7" runat="server" Text="J7" class ="btn btn-block"/>
                            </td>
                        </tr>
                        <tr>
                            <td>8</td>
                            <td>
                                <asp:Button ID="A8" runat="server" Text="A8" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="B8" runat="server" Text="B8" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="C8" runat="server" Text="C8" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="D8" runat="server" Text="D8" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="E8" runat="server" Text="E8" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="F8" runat="server" Text="F8" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="G8" runat="server" Text="G8" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="H8" runat="server" Text="H8" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="I8" runat="server" Text="I8" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="J8" runat="server" Text="J8" class ="btn btn-block"/>
                            </td>
                        </tr>
                        <tr>
                            <td>9</td>
                            <td>
                                <asp:Button ID="A9" runat="server" Text="A9" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="B9" runat="server" Text="B9" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="C9" runat="server" Text="C9" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="D9" runat="server" Text="D9" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="E9" runat="server" Text="E9" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="F9" runat="server" Text="F9" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="G9" runat="server" Text="G9" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="H9" runat="server" Text="H9" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="I9" runat="server" Text="I9" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="J9" runat="server" Text="J9" class ="btn btn-block"/>
                            </td>
                        </tr>
                        <tr>
                            <td>10</td>
                            <td>
                                <asp:Button ID="A10" runat="server" Text="A10" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="B10" runat="server" Text="B10" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="C10" runat="server" Text="C10" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="D10" runat="server" Text="D10" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="E10" runat="server" Text="E10" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="F10" runat="server" Text="F10" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="G10" runat="server" Text="G10" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="H10" runat="server" Text="H10" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="I10" runat="server" Text="I10" class ="btn btn-block"/>
                            </td>
                            <td>
                                <asp:Button ID="J10" runat="server" Text="J10" class ="btn btn-block"/>
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <div class="row">
                <div class="col-md-5" style="background-color:white;padding:20px;">
                    <asp:Label ID="Label1" runat="server" Text="Score"></asp:Label>: <asp:Label ID="lblScore" runat="server" Text="0"></asp:Label>
                    <asp:Label ID="Label3" runat="server" Text="Shot Was"></asp:Label>: <asp:Label ID="lblShot" runat="server" Text="-"></asp:Label>
                    <asp:Label ID="Label4" runat="server" Text="Hint"></asp:Label>: <asp:Label ID="lblhint" runat="server" Text="-"></asp:Label>
                </div>
                <div class="col-md-2">
